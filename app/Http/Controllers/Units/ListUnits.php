...
class ListUnits extends Controller
{
    ...
    public function enable($id)
    {
        ...
        if (!$object) {
            return Report::error(self::ROUTE, 'Unidad no encontrada.');
        } elseif ($object->status == $enabled_value) {
            return Report::error(self::ROUTE, 'La unidad ya está habilitada.');
        }
    ...
    public function disable($id)
    {
        ...
        if (!$object) {
            ...
            return Report::error(self::ROUTE, 'La unidad ya está deshabilitada.');
        }
